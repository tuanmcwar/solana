...
export const processTokensProfile = async (mappingData) => {
    ...
    const filteredData = allDetails.filter(item =>
        ...
        // item.gecko?.data?.attributes?.gt_score >= 20
    );
    ...
    for (const item of filteredData) {
        ...
        if (!existingTokenData) {
            ...
            if (lpLocked.lpLockedPercentage >= 50 && sumTop1Holder < 30 && sumTop10Holder  < 300 && sumTop20Holder < 500  && scoreRugCheck < 10000 /*&& totalHoldersRugCheck > 500*/) {
